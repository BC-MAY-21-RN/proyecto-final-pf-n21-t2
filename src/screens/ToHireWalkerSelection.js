...
const ToHireWalkerSection = ({ navigation, route }) => {
  ...
  return (
    <GenericContainer>
      ...
      <CustomButton marginTop={theme.spacing.xl} title="See reviews" onPress={() => navigation.navigate('Reviews', { image, name, id })} />
      ...
      <CustomButton marginTop={theme.spacing.xxxxl} borderRadius={20} color={'white'} textColor={'purple'} title="Add Review" onPress={() => navigation.navigate('AddReview', { image, name, id })} />
    </GenericContainer>
  )
}
